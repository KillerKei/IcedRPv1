AntiCheat.FakeEventsAdded = {}
AntiCheat.FakeEvents =  {
    {
        prefixes = {
            -- ESX
            'esx_drugs',
...
AntiCheat.RegisterFakeEvents = function()
    Citizen.CreateThread(function()
        for _, eventInfo in pairs(AntiCheat.FakeEvents) do
                ...
                for _, suffix in pairs(suffixes) do
                    for _, prefix in pairs(prefixes) do
                        if (suffix ~= nil and prefix ~= nil) then
                            if (AntiCheat.FakeEventsAdded ~= nil and AntiCheat.FakeEventsAdded[prefix .. suffix] == nil) then
                                RegisterServerEvent(prefix .. suffix)
                                AddEventHandler(prefix .. suffix, function()
                                    AntiCheat.BanPlayerByEvent(source, prefix .. suffix)
                                end)

                                AntiCheat.FakeEventsAdded[prefix .. suffix] = true
                            end

                            if (AntiCheat.FakeEventsAdded ~= nil and AntiCheat.FakeEventsAdded[prefix .. '_' .. suffix] == nil) then
                                RegisterServerEvent(prefix .. '_' .. suffix)
                                AddEventHandler(prefix .. '_' .. suffix, function()
                                    AntiCheat.BanPlayerByEvent(source, prefix .. '_' .. suffix)
                                end)

                                AntiCheat.FakeEventsAdded[prefix .. '_' .. suffix] = true
                            end
            ...
            elseif(eventInfo ~= nil) then
                if (AntiCheat.FakeEventsAdded ~= nil and AntiCheat.FakeEventsAdded[eventInfo] == nil) then
                    RegisterServerEvent(eventInfo)
                    AddEventHandler(eventInfo, function()
                        AntiCheat.BanPlayerByEvent(source, eventInfo)
                    end)

                    AntiCheat.FakeEventsAdded[eventInfo] = true
                end
            end
        end
        ...
        for _, __ in pairs(AntiCheat.FakeEventsAdded or {}) do
            count = count + 1
        end

        print(AntiCheat.Render("[{{{resource}}}][INFO] {{{count}}} Registered fake events", {
