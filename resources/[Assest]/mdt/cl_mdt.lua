...
Citizen.CreateThread(function()
    while true do
        ...
        if not isVisible and IsPedInAnyPoliceVehicle(playerPed) and IsControlJustPressed(0, 265) and GetEntitySpeed(playerVeh) < 10.0 then
        ...
        elseif IsControlJustPressed(0, 265) then
