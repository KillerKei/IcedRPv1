...
mumbleConfig = {
	...
	voiceModes = {
		...
		{34.0, "Shouting"}, -- Shout speech distance in gta distance units
	},
	...
	radioClickMaxChannel = 999.9, -- Set the max amount of radio channels that will have local radio clicks enabled
	...
	radioChannelNames = { -- Add named radio channels (Defaults to [channel number] MHz)
		[1] = "PD Radio 🎧🎤",
		[2] = "EMS Radio 🎧🎤",
		[3] = "PD/SO/EMS Shared Radio 🎧🎤",
		[4] = "SO Radio 🎧🎤",
		[5] = "PD/SO Shared Radio 🎧🎤",
		[6] = "Training 🎧🎤",
		[7] = "Tow Radio 🎧🎤",
	},
