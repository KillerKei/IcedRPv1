...
RegisterNetEvent("radioEnabled")
AddEventHandler("radioEnabled", function(radioopensent)
 radioopen = radioopensent
end)
...
AddEventHandler('np-base:addedMoney', function(amount)
	cash = math.ceil(amount)
end)
