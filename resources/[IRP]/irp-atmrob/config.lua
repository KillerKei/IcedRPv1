...
Config.PoliceNotfiyEnabled = false		-- police notification upon truck robbery enabled (true) or disabled (false)
...
-- Reward Settings:
Config.EnableDirtyCash = false			-- Set between true(receive dirty cash) or false(receive normal cash)		
Config.MinReward = 500					-- Set minimum payout
Config.MaxReward = 1000					-- Set maximum payout
