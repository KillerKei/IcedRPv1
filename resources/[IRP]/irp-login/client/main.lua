...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
			...
			TriggerServerEvent("irp-scoreboard:AddPlayer")
			TriggerServerEvent('irp-admin:AddPlayer')
...
RegisterNetEvent('irp-login:swapcharacter')
AddEventHandler('irp-login:swapcharacter', function()
	TriggerEvent("kashactersC:WelcomePage")
...
local function disconnect()
    TriggerServerEvent("irp-login:disconnectPlayer")
end
