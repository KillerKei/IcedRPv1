...
function EnableSocietyMoneyHUDElement()
	...
	irpCore.UI.HUD.RegisterElement('society_money', 3, 0, societyMoneyHUDElementTpl, {
		money = 0
	})
end

function DisableSocietyMoneyHUDElement()
	irpCore.UI.HUD.RemoveElement('society_money')
end

function UpdateSocietyMoneyHUDElement(money)
	irpCore.UI.HUD.UpdateElement('society_money', {
		money = money
	})
end
...
function OpenBossMenu(society, close, options)
	...
	irpCore.TriggerServerCallback('irp-society:isBoss', function(result)
		isBoss = result
	end, society)
	...
	irpCore.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
	{
		title    = _U('boss_menu'),
		align    = 'top-left',
		elements = elements
		...
		if data.current.value == 'withdraw_society_money' then
			...
			irpCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('irp-society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			irpCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('irp-society:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			irpCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('irp-society:washMoney', society, amount)
				end
...
function OpenManageEmployeesMenu(society)
	...
	irpCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_employees_' .. society,
	{
...
function OpenEmployeeList(society)
	...
	irpCore.TriggerServerCallback('irp-society:getEmployees', function(employees)
		...
		irpCore.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				irpCore.TriggerServerCallback('irp-society:setJob', function()
					OpenEmployeeList(society)
...
function OpenRecruitMenu(society)
	...
	irpCore.TriggerServerCallback('irp-society:getOnlinePlayers', function(players)
		...
		irpCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			title    = _U('recruiting'),
			align    = 'top-left',
			elements = elements
			...
			irpCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
...
function OpenPromoteMenu(society, employee)
	...
	irpCore.TriggerServerCallback('irp-society:getJob', function(job)
		...
		irpCore.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
...
function OpenManageGradesMenu(society)
	...
	irpCore.TriggerServerCallback('irp-society:getJob', function(job)
		...
		irpCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			irpCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					...
					irpCore.TriggerServerCallback('irp-society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('irp:playerLoaded', function(xPlayer)
	...
	if PlayerData.job.grade_name == 'boss' then
		...
		irpCore.TriggerServerCallback('irp-society:getSocietyMoney', function(money)
...
RegisterNetEvent('irp-addonaccount:setMoney')
AddEventHandler('irp-addonaccount:setMoney', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('irp-society:openBossMenu', function(society, close, options)
