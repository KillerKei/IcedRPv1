...
// function irp-refresh:func(src)
// {
//     emitNet('irp-refresh:open',src)
// }
...
function PoliceArmory() {
    var shopItems = [
        ...
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 6, amount: 10 },
        { item_id: "3219281620", id: 0, name: "Shop", information: "{}", slot: 7, amount: 1 },
        { item_id: "911657153", id: 0, name: "Shop", information: "{}", slot: 8, amount: 1 },
        { item_id: "1432025498", id: 0, name: "Shop", information: "{}", slot: 9, amount: 1 },
        { item_id: "487013001", id: 0, name: "Shop", information: "{}", slot: 10, amount: 1 },
        { item_id: "736523883", id: 0, name: "Shop", information: "{}", slot: 11, amount: 1 },
        { item_id: "-2084633992", id: 0, name: "Shop", information: "{}", slot: 12, amount: 1 },
        { item_id: "-86904375", id: 0, name: "Shop", information: "{}", slot: 13, amount: 1 },
        { item_id: "-771403250", id: 0, name: "Shop", information: "{}", slot: 14, amount: 1 },
        { item_id: "radio", id: 0, name: "Shop", information: "{}", slot: 15, amount: 10 },
        { item_id: "2343591895", id: 0, name: "Shop", information: "{}", slot: 16, amount: 1 },
        { item_id: "1737195953", id: 0, name: "Shop", information: "{}", slot: 17, amount: 1 },
        { item_id: "IFAK", id: 0, name: "Shop", information: "{}", slot: 18, amount: 10 },
        { item_id: "watch", id: 0, name: "Shop", information: "{}", slot: 19, amount: 1 },
    ];
    return JSON.stringify(shopItems);
}
...
function bennys() {
    var shopItems = [
        { item_id: "advlockpick", id: 0, name: "craft", information: "{}", slot: 1, amount: 10},
        { item_id: "lockpick", id: 0, name: "craft", information: "{}", slot: 2, amount: 10},
        { item_id: "advrepairkit", id: 0, name: "craft", information: "{}", slot: 3, amount: 10},
    ];
    return JSON.stringify(shopItems);
};
...
function lsc() {
    var shopItems = [
        { item_id: "lockpick", id: 0, name: "craft", information: "{}", slot: 1, amount: 10},
        { item_id: "advrepairkit", id: 0, name: "craft", information: "{}", slot: 3, amount: 10},
        { item_id: "tuner", id: 0, name: "craft", information: "{}", slot: 2, amount: 1},
    ];
    return JSON.stringify(shopItems);
};
...
function HardwareStore() {
    var shopItems = [
        ...
        { item_id: "repairkit", id: 0, name: "Shop", information: "{}", slot: 8, amount: 5 },
        { item_id: "lsdtab", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
