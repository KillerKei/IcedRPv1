Locales['en'] = {
  -- BOSS MENU:
  ['boss_menu']             	= '[E] Boss Menu',
  ['employee_menu']          	= 'Employee Menu',
  ['accounts_menu']           = 'Account Menu',
  ...
  ['withdrew_amount']           = 'You withdrew $%s from the account',
  ['deposited_amount']          = 'You deposited $%s into the account',
  ...
  ['return_test_veh']      	  	= '[E] TO RETURN TEST VEHICLE',
  ...
  ['veh_repossessed_warning']   = 'You have unpaid repayments, pay within %s minutes, else they will be repossessed',
  ['veh_repossessed']  		    	= 'Your vehicle with plate: %s has been repossessed',
  ['plate_nil']  			        	= 'The typed plate is not valid...',
  
  -- DISPLAY VEHICLE:
  ['swap_car_label']          	= '[G] Swap',
  ['confirm_cancel_purchase']   = '[E] Sign Papers | [BACKSAPCE] to cancel',
  ['min_commission_limit']     	= 'You reached minimum allowed commission',
  ['max_commission_limit']     	= 'You reached maximum allowed commission',
  ['confirm_cancel_finance']    = '[L] Sign Financing Papers | [BACKSAPCE] to cancel',
