...
Config.DisplayCars = {
	...
	[7] = { Pos = {-36.05,-1099.32,26.42}, Heading = 145.77 },	-- This is: SUVs, Utility, Vans & Off Road// DO NOT TOUCH 
...
Config.KeyToFinanceVeh 		= 182	-- L			: Key to finance vehicle from display
Config.KeyToConfirmFinance 	= 182	-- L 			: Key to confirm vehicle finance from display
...
Config.MaxDownpayment 			= 100		-- set maximum allowed downpayment that car seller can go down to in %
Config.MaxTimePerRepay 			= 672		-- set max time before a repay in hours
Config.AmountOfRepayments 		= 25		-- set amount of repayments in total, where (carPrice-downPayment)/10 will be minimum repay amount
...
Config.PayWithBankMoney 		= false		-- set to false in order to pay repayments with cash money on player
