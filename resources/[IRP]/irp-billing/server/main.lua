...
RegisterServerEvent('irp-billing:sendBill')
AddEventHandler('irp-billing:sendBill', function(playerId, sharedAccountName, label, amount)
	local _source = source
	local xPlayer = irpCore.GetPlayerFromId(_source)
	local xTarget = irpCore.GetPlayerFromId(playerId)

	TriggerEvent('irp-addonaccount:getSharedAccount', sharedAccountName, function(account)
...
irpCore.RegisterServerCallback('irp-billing:getBills', function(source, cb)
...
irpCore.RegisterServerCallback('irp-billing:getTargetBills', function(source, cb, target)
...
irpCore.RegisterServerCallback('irp-billing:payBill', function(source, cb, id)
	local xPlayer = irpCore.GetPlayerFromId(source)
	...
	MySQL.Async.fetchAll(
		'SELECT * FROM billing WHERE id = @id',
		{
			...
			local xTarget = irpCore.GetPlayerFromIdentifier(sender)
			...
			if targetType == 'player' then
				...
				TriggerEvent('irp-addonaccount:getSharedAccount', target, function(account)
