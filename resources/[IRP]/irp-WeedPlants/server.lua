...
RegisterServerEvent("irp-weedplants:purifiedwater")
AddEventHandler("irp-weedplants:purifiedwater", function(id)
  local xPlayer = irpCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); irpCore.GetPlayerFromId(source); end
...
RegisterServerEvent("irp-weedplants:highgradefert")
AddEventHandler("irp-weedplants:highgradefert", function(id)
  local xPlayer = irpCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); irpCore.GetPlayerFromId(source); end
...
RegisterServerEvent("irp-weedplants:highgrademaleseed")
AddEventHandler("irp-weedplants:highgrademaleseed", function(id)
  local xPlayer = irpCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); irpCore.GetPlayerFromId(source); end
...
RegisterServerEvent("irp-weedplants:highgradefemaleseed")
AddEventHandler("irp-weedplants:highgradefemaleseed", function(id)
  local xPlayer = irpCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); irpCore.GetPlayerFromId(source); end
