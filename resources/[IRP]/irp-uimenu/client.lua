callbackData = nil
RegisterNetEvent('irp-uimenu:createMenu')
AddEventHandler('irp-uimenu:createMenu', function(myMenu, cb)
    callbackData = nil
    SendNUIMessage({
        action = "show",
        menu = myMenu
...
--    TriggerEvent("irp-uimenu:createMenu", myListMenu, function(value)
...
--    TriggerEvent("irp-uimenu:createMenu", myMultiMenu, function(value)
...
--    TriggerEvent("irp-uimenu:createMenu", myHoverMenu, function(value)
