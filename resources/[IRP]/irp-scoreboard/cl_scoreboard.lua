...
RegisterNetEvent("irp-scoreboard:RemovePlayer")
AddEventHandler("irp-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("irp-scoreboard:AddPlayer")
AddEventHandler("irp-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("irp-scoreboard:RemoveRecent")
AddEventHandler("irp-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("irp-scoreboard:AddAllPlayers")
AddEventHandler("irp-scoreboard:AddAllPlayers", function(data)
                ...
                if NetworkIsPlayerActive( id ) --[[ and GetPlayerPed( id ) ~= GetPlayerPed( -1 )) ]] then
                    ...
                    if ped == playerped then
                        ...
                        if (distance < disPlayerNames) then
                            if exports["mumble-voip"]:SetMumbleProperty(GetPlayerServerId(id)) == 1 == 1 then
                                if cansee then
