...
RegisterServerEvent('irp-scoreboard:AddPlayer')
AddEventHandler("irp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("irp-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("irp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("irp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("irp-scoreboard:RemoveRecent", -1, plyid)
end)
