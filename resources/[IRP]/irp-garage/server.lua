...
irpCore.RegisterServerCallback('irp-garage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
AddEventHandler('garages:CheckForSpawnVeh', function(veh_id, garageCost)
  ...
  AddEventHandler('onResourceStart', function(resource)
	if GetCurrentResourceName() == 'irp-garage' then
  ...
  RegisterServerEvent('irp-garage:putcaringarage')
  AddEventHandler('irp-garage:putcaringarage', function()
	if GetCurrentResourceName() == 'irp-garage' then
		Citizen.CreateThread(function()
			Citizen.Wait(1)
			ImpoundCarOut()
