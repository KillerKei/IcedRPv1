...
local crthouseLocs = {
    [1] = { ["x"] = 225.9176, ["y"] = -426.9529, ["z"] = 48.07677, ["name"] = "[E] Open Public Records", ["fnc"] = "DrawText3DTest" },
}
...
RegisterNetEvent("mdt-civ:billPlayer")
AddEventHandler("mdt-civ:billPlayer", function(src, sharedAccountName, label, amount)
