...
--- Config ---
notWhitelistedMessage = "Please join the discord to play on the server. Discord: https://Discord.Me/Iced-Roleplay" -- Message displayed when they are not whitelist with the role
