...
RegisterServerEvent('irp-chopshop:addCash')
AddEventHandler('irp-chopshop:addCash', function()
...
irpCore.RegisterServerCallback('irp-chopshop:isdead', function(source, cb)
...
irpCore.RegisterServerCallback('irp-chopshop:getVehInfos', function(source, cb, plate)
