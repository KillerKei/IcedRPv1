...
RegisterServerEvent('irp-jobnumbers:setjobs')
AddEventHandler('irp-jobnumbers:setjobs', function(jobname)
...
function AnnounceJobs()
    ...
    TriggerClientEvent('irp-jobnumbers:setjobs', -1, sendingjobs)
end
