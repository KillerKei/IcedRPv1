...
if Config.MaxInService ~= -1 then
	TriggerEvent('irp-service:activateService', 'police', Config.MaxInService)
end
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		...
		local user = irpCore.GetPlayerFromId(_source)
...
AddEventHandler('reviveGranted', function(target)
	local xPlayer = irpCore.GetPlayerFromId(source)
		...
		--TriggerClientEvent('irpCore_ambulancejob:revive', target)
		Wait(5000)
