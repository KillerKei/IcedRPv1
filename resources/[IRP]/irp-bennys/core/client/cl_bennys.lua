...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("irp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("irp-bennys:purchaseSuccessful")
AddEventHandler("irp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("irp-bennys:purchaseFailed")
AddEventHandler("irp-bennys:purchaseFailed", function()
