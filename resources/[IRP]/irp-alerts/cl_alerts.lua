...
RegisterNetEvent('irp-outlawalert:gunshotInProgress')
AddEventHandler('irp-outlawalert:gunshotInProgress', function(targetCoords)
...
AddEventHandler('irp-alerts:gunshot', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:shoot', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Fight ----

RegisterNetEvent('irp-outlawalert:combatInProgress')
AddEventHandler('irp-outlawalert:combatInProgress', function(targetCoords)
	if irpCore.GetPlayerData().job.name == 'police' then	
		if Config.gunAlert then
			local alpha = 250
...
AddEventHandler('irp-alerts:fight', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:figher', {x = pos.x, y = pos.y, z = pos.z})
end)

---- 10-13s Officer Down ----

RegisterNetEvent('irp-alerts:policealertA')
AddEventHandler('irp-alerts:policealertA', function(targetCoords)
...
AddEventHandler('irp-alerts:1013A', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:teenA', {x = pos.x, y = pos.y, z = pos.z})
end)

RegisterNetEvent('irp-alerts:policealertB')
AddEventHandler('irp-alerts:policealertB', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:1013B', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:teenB', {x = pos.x, y = pos.y, z = pos.z})
end)


RegisterNetEvent('irp-alerts:panic')
AddEventHandler('irp-alerts:panic', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:policepanic', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:teenpanic', {x = pos.x, y = pos.y, z = pos.z})
end)


---- 10-14 EMS ----

RegisterNetEvent('irp-alerts:tenForteenA')
AddEventHandler('irp-alerts:tenForteenA', function(targetCoords)
  if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:1014A', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:fourA', {x = pos.x, y = pos.y, z = pos.z})
end)


RegisterNetEvent('irp-alerts:tenForteenB')
AddEventHandler('irp-alerts:tenForteenB', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:1014B', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:fourB', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Down Person ----

RegisterNetEvent('irp-alerts:downalert')
AddEventHandler('irp-alerts:downalert', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:downguy', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:downperson', {x = pos.x, y = pos.y, z = pos.z})
end)

---- assistance ----
RegisterNetEvent('irp-alerts:assistance')
AddEventHandler('irp-alerts:assistance', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:assistanceneeded', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:assistancen', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Car Crash ----

RegisterNetEvent('irp-alerts:vehiclecrash')
AddEventHandler('irp-alerts:vehiclecrash', function()
if irpCore.GetPlayerData().job.name == 'police' or irpCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
RegisterNetEvent('irp-alerts:vehiclesteal')
AddEventHandler('irp-alerts:vehiclesteal', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:stolenveh', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:sveh', {x = pos.x, y = pos.y, z = pos.z})
end)


---- Store Robbery ----

RegisterNetEvent('irp-alerts:storerobbery')
AddEventHandler('irp-alerts:storerobbery', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:robstore', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:storerob', {x = pos.x, y = pos.y, z = pos.z})
end)

---- House Robbery ----

RegisterNetEvent('irp-alerts:houserobbery')
AddEventHandler('irp-alerts:houserobbery', function(targetCoords)
if irpCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:robhouse', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:houserob', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Bank Truck ----

RegisterNetEvent('irp-alerts:banktruck')
AddEventHandler('irp-alerts:banktruck', function(targetCoords)
	if irpCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:bankt', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('irp-alerts:tbank', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Jewerly Store ----

RegisterNetEvent('irp-alerts:jewelrobbey')
AddEventHandler('irp-alerts:jewelrobbey', function()
	if irpCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:jewrob', function()
	TriggerServerEvent('irp-alerts:robjew')
end)

---- Jail Break ----

RegisterNetEvent('irp-alerts:jailbreak')
AddEventHandler('irp-alerts:jailbreak', function()
	if irpCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('irp-alerts:jailb', function()
	TriggerServerEvent('irp-alerts:bjail')
end)